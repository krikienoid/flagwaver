...
;(function (window, undefined) {
    ...
    function getVarsFromHash(hash) {
        ...
        var pos  = hash.indexOf(settings.startingChar);
        var pairs, i, ii, pair, key;
    ...
    function getData(hash) {
        var data = {};
        var vars = getVarsFromHash(hash);
        var i, ii, hashVar, str;
    ...
    function configure(opts) {
        if (opts) {
            ...
            settings.useHistoryAPI = !!(opts.useHistoryAPI && isHistorySupported);
        }
